...
const vitaqSyncFunctions = __importStar(require("./functionsSync.js"));
const vitaqAsyncFunctions = __importStar(require("./functionsAsync.js"));
...
class VitaqService {
    constructor(serviceOptions, capabilities, config) {
        ...
        try {
            ...
            this._capabilities = capabilities !== null && capabilities !== void 0 ? capabilities : {};
            ...
            if (this._config.debug) {
                ...
                this._options = Object.assign(Object.assign(Object.assign(Object.assign({}, defaults_js_1.DEFAULT_OPTIONS), debugOptions), serviceOptions), this._config);
            }
            else {
                this._options = Object.assign(Object.assign(Object.assign({}, defaults_js_1.DEFAULT_OPTIONS), serviceOptions), this._config);
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (suite.root) {
                ...
                if (this.nextAction === "") {
                    ...
                    yield this.getNextAction(undefined, result);
                }
                else {
                    log.debug("nextActionSelector: Last action was: ", this.nextAction);
                    yield this.getNextAction(this.nextAction, result);
                }
                ...
                while (specialActions.indexOf(this.nextAction) > -1) {
                    ...
                    if (this.nextAction === '--*setUp*--') {
                        ...
                        if (this.sessionReloadNeeded) {
                            // @ts-ignore
                            yield this._browser.reloadSession();
                        }
                        // Show which seed we are about to run
                        const seed = yield this.vitaqFunctions.getSeed('top', this._browser, this._api);
                        log.info(`====================   Running seed: ${seed}   ====================`);
                        yield this.getNextAction('--*setUp*--', true);
                        this.currentState = "passed";
                    }
                    else if (this.nextAction === '--*tearDown*--') {
                        // Do nothing on tearDown - just go to the next action
                        yield this.getNextAction('--*tearDown*--', true);
                        this.currentState = "passed";
                    }
                        ...
                        yield this.getNextAction('--*EndSeed*--', true);
                        this.currentState = "passed";
                    }
                        ...
                        return yield this.getNextAction('--*EndAll*--', true);
                    }
                }
     ...
     */
    getNextAction(lastActionName, result) {
        return __awaiter(this, void 0, void 0, function* () {
            this.nextAction = yield this._api.getNextTestActionCaller(lastActionName, result);
        });
    }
    // -------------------------------------------------------------------------
    /**
    ...
    deleteSession() {
        return __awaiter(this, void 0, void 0, function* () {
            // @ts-ignore
            yield this._browser.deleteSession();
            // @ts-ignore
    ...
    beforeSession(config, capabilities) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                scriptResult = yield this.waitForScript(this._options.scriptTimeout, 100);
            }
            catch (error) {
            ...
            if (scriptResult === "script_success") {
                try {
                    sessionResult = yield this.waitForSession(this._options.sessionTimeout, 100);
                }
                catch (error) {
                    if (error === "failed") {
