...
function requestData(variableName, browser, api) {
    return __awaiter(this, arguments, void 0, function* () {
        ...
        let result = yield api.requestDataCaller(variableName);
        log.info(`   -> ${result}`);
        return result;
    });
}
...
function readDataFromVitaq(variableName, browser, api) {
    return __awaiter(this, arguments, void 0, function* () {
        ...
        let result = yield api.readDataFromVitaqCaller(variableName);
        log.info(`   -> ${result}`);
        return result;
    });
}
...
function displayNextActions(actionName, browser, api) {
    return __awaiter(this, arguments, void 0, function* () {
        ...
        // @ts-ignore
        let result = yield api.runCommandCaller('display_next_sequences', args);
        log.info(`   -> ${result}`);
        return result;
    });
}
...
function getCallCount(actionName, browser, api) {
    return __awaiter(this, arguments, void 0, function* () {
        ...
        // @ts-ignore
        let result = yield api.runCommandCaller('get_call_count', args);
        log.info(`   -> ${result}`);
        return result;
    });
}
...
function getCallLimit(actionName, browser, api) {
    return __awaiter(this, arguments, void 0, function* () {
        ...
        // @ts-ignore
        let result = yield api.runCommandCaller('get_call_limit', args);
        log.info(`   -> ${result}`);
        return result;
    });
}
...
function getEnabled(actionName, browser, api) {
    return __awaiter(this, arguments, void 0, function* () {
        ...
        // @ts-ignore
        let result = yield api.runCommandCaller('get_enabled', args);
        log.info(`   -> ${result}`);
        return result;
    });
}
...
function getId(actionName, browser, api) {
    return __awaiter(this, arguments, void 0, function* () {
        ...
        // @ts-ignore
        let result = yield api.runCommandCaller('get_id', args);
        log.info(`   -> ${result}`);
        return result;
    });
}
...
function nextActions(actionName, browser, api) {
    return __awaiter(this, arguments, void 0, function* () {
        ...
        // @ts-ignore
        let result = yield api.runCommandCaller('next_sequences', args);
        log.info(`   -> ${result}`);
        return result;
    });
}
...
function numberActiveNextActions(actionName, browser, api) {
    return __awaiter(this, arguments, void 0, function* () {
        ...
        // @ts-ignore
        let result = yield api.runCommandCaller('number_active_next_sequences', args);
        log.info(`   -> ${result}`);
        return result;
    });
}
...
function numberNextActions(actionName, browser, api) {
    return __awaiter(this, arguments, void 0, function* () {
        ...
        // @ts-ignore
        let result = yield api.runCommandCaller('number_next_sequences', args);
        log.info(`   -> ${result}`);
        return result;
    });
}
...
function getDoNotRepeat(variableName, browser, api) {
    return __awaiter(this, arguments, void 0, function* () {
        ...
        // @ts-ignore
        let result = yield api.runCommandCaller('get_do_not_repeat', args);
        log.info(`   -> ${result}`);
        return result;
    });
}
...
function getSeed(variableName, browser, api) {
    return __awaiter(this, arguments, void 0, function* () {
        ...
        // @ts-ignore
        let result = yield api.runCommandCaller('get_seed', args);
        log.info(`   -> ${result}`);
        return result;
    });
}
...
function getValue(variableName, browser, api) {
    return __awaiter(this, arguments, void 0, function* () {
        ...
        // @ts-ignore
        let result = yield api.runCommandCaller('get_value', args);
        log.info(`   -> ${result}`);
        return result;
    });
}
