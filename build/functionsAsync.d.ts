 ...
 * @param api
 */
export declare function getPrevious(actionName: string, steps: number, browser: Browser<'async'> | MultiRemoteBrowser<'async'>, api: VitaqAiApi): Promise<string>;
/**
 ...
 * @param api
 */
export declare function setValue(variableName: string, value: any, browser: Browser<'async'> | MultiRemoteBrowser<'async'>, api: VitaqAiApi): Promise<any>;
